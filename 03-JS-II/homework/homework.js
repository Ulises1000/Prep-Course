...
function operadoresLogicos(num1, num2, num3) {
  ...
  for(let i = 0; i < num.length; i++){
    if(num[i] < 0) return "Hay negativos";
    else if(num[i] === 0) return "Error";
  }

  if(num[0] > num[1] && num[0] > num[2] && num[0] > 0) return "Número 1 es mayor y positivo";
  else if(num[2] > num[0] && num[2] > num[1]) return ++num[2];
